...
// ЗАКОММЕНТИРОВАНО: Старая логика меню для параметров
...
// Базовые пункты меню (без параметров)
...
// Меню будет генерироваться динамически из API
// Используется useDynamicMenu в компоненте Menu для объединения с baseMenuItems
